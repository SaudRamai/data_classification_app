...
for key in (
    ...
    if val is not None:
        ...
        # Specific fallback for database name if set to 'NONE'
        if key == "SNOWFLAKE_DATABASE" and val_str in ("NONE", "NULL", "", "UNDEFINED"):
            setattr(settings, key, "DATA_CLASSIFICATION_DB")
        elif val_str in ("NONE", "NULL", "(NONE)", "UNKNOWN", "", "UNDEFINED", "N/A"):
