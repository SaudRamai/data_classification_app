...
def _apply_streamlit_safety_patch() -> None:
    ...
    st.markdown(
        ...
        *[style*="background"],
        ...
        /* Enhanced Pillar Card Grid (Compliance) */
        .compliance-grid {
            display: grid;
        ...
        .pillar-card-v2.blue { border-top-color: #38bdf8; box-shadow: inset 0 0 20px rgba(56, 189, 248, 0.05); }
        .pillar-card-v2.yellow { border-top-color: #fbbf24; box-shadow: inset 0 0 20px rgba(251, 191, 36, 0.05); }
        .pillar-card-v2.red { border-top-color: #f87171; box-shadow: inset 0 0 20px rgba(248, 113, 113, 0.05); }
        .pillar-card-v2.green { border-top-color: #34d399; box-shadow: inset 0 0 20px rgba(52, 211, 153, 0.05); }
        ...
        .check-status.passed { background: #10b981; color: white; }
        .check-status.failed { background: #ef4444; color: white; }
        ...
        .circular-metric {
            ...
            height: 80px;
            border-radius: 50%;
            background: conic-gradient(#38bdf8 var(--percentage), #1e293b 0);
            display: flex;
            align-items: center;
            justify-content: center;
        }
