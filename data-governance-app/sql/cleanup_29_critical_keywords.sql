-- ============================================================================
-- CRITICAL KEYWORDS CLEANUP - CORRECT SCHEMA
-- ============================================================================
-- This script removes lower-risk keywords from:
-- DATA_CLASSIFICATION_DB.DATA_CLASSIFICATION_GOVERNANCE.SENSITIVE_KEYWORDS
--
-- This matches where the Python upsert/insert code now saves data.
-- ============================================================================
...
SELECT 
    'ALL CRITICAL KEYWORDS' AS STATUS,
    sc.CATEGORY_NAME,
    sk.KEYWORD_STRING,
    sk.MATCH_TYPE,
    sk.SENSITIVITY_WEIGHT,
...
-- 1. Test inline edits in the dashboard
-- 2. Query: SELECT * FROM DATA_CLASSIFICATION_DB.DATA_CLASSIFICATION_GOVERNANCE.SENSITIVE_KEYWORDS
-- 3. Verify changes appear in the correct location
-- ============================================================================
